    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            HStack {
                ...
                NavigationLink(destination: NewAccountNameView(), isActive: $showName) { EmptyView() }
            }
            .padding()
        }
    }
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            HStack {
                ...
                NavigationLink(destination: LoadingView(), isActive: $showLoading) { EmptyView() }
            }
            .padding()
        }
...
// ExistingAccountView shows the sign-in form
